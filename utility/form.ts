...
export const socials: socialsKeyType = {
    whatsapp: {
        icon: WhatsAppIcon,
        placeholder: "+971",
        save: (value) => value ? `https://wa.me/${value}` : "",
        out: (value) => value ? value.replace('https://wa.me/', "") : ""
    },
    instagram: {
        icon: InstagramIcon,
        placeholder: "Nickname",
        save: (value) => value ? `https://www.instagram.com/${value}` : "",
    ...
    telegram: {
        icon: TelegramIcon,
        placeholder: "Nickname",
        save: (value) => value ? `https://t.me/${value}` : '',
        out: (value) => value ? value.replace('https://t.me/', "") : ""
    },
    wechat: {
        icon: WechatIcon,
        placeholder: "Nickname",
        save: (value) => value ? `https://wechat.com/${value}` : '',
        out: (value) => value ? value.replace('https://wechat.com/', "") : ""
    },
    snapchat: {
        icon: SnapchatIcon,
        placeholder: "Nickname",
        save: (value) => value ? `https://snapchat.com/add/${value}` : '',
        out: (value) => value ? value.replace('https://snapchat.com/add/', "") : ""
    },
    tiktok: {
        icon: TikTokIcon,
        placeholder: "Nickname",
        save: (value) => value ? `https://tiktok.com/@${value}` : "",
