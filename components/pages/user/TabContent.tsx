...
import {noDataText, outContactsInfo, outWorkInfo, socialsOut} from "../../../constants/main";
...
import DarkButtons from "../profile/DarkButtons";
...
export const WorkInfo: FC = () => {
    ...
    return (
        <Box className={styles.wrapper}>
            ...
            <Typography textAlign="center" component="p" fontSize={workInfoTitleFontSize} fontWeight="400"
            ...
            {addressInfo.length ? addressInfo.map((elem, i) => (
                <MuiLink underline="none" key={i} href={elem.link} target='_blank'>
                  <Box className={styles.addressBox}>
                        ...
                        <Typography fontSize={workInfoTitleFontSize} fontWeight="400" style={{textDecoration:"underline"}}
                                    className={clsx(styles.workInfoTitle, {dark: isDarkMode})}>
                                Visit address
                                <br {...data.address ? data.address : noDataText} style={{display: "none"}}/>
                        </Typography>
                    </Box>
                </MuiLink>
            )) : (
                <Box className={styles.addressBox}>
                    {data.address ? <LocationOnIcon
                        className={clsx(styles.addressIcon, styles.workInfoTitle, {dark: isDarkMode})}/> : noDataText}
