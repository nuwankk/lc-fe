...
export const WorkInfo: FC = () => {
    ...
    const getCards = () => {
        fetch(`http://https://api.limitless-connection.com/api/v1/users/images/${authState?.profile?.uniqueId}`, {
            headers: {
        ...
        fetch(`http://https://api.limitless-connection.com/api/v1/users/videos/${authState?.profile?.uniqueId}`, {
            headers: {
                "Authorization": `Bearer ${accses}`,
            }
        }).then((res) => res.json())
