...
export const check = createAsyncThunk(
    'auth/login',
    async (_, {dispatch}) => {
        const refresh = localStorage.getItem('refresh') ? localStorage.getItem('refresh') : "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTY4MTQwMDQ1OSwiaWF0IjoxNjc4ODA4NDU5LCJqdGkiOiI2MTIwZDhjNTVmZmY0MmZjOTI5NDk2YWMyNWY2YmE3ZSIsInVzZXJfaWQiOjUyNzJ9.fuViO0xcnsSPjRPJMB-CwdKudOkbCygZ9kc8ds6eAQo";
        if(!refresh){
